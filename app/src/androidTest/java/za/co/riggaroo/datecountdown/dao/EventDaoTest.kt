...
class EventDaoTest {
    ...
    @Singleton
    @Component(modules = arrayOf(MockCountdownModule::class))
    interface MockCountdownComponent : CountdownComponent {
    ...
    fun setup() {
        ...
        val app = instrumentation.targetContext.applicationContext as MockCountDownApplication
        val component = app.countDownComponent as MockCountdownComponent
