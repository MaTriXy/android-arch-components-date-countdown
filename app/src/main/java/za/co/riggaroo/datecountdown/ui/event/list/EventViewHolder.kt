...
class EventViewHolder(v: View) : RecyclerView.ViewHolder(v) {
    ...
    var descriptionTextView: TextView = v.findViewById(R.id.text_view_event_description) as TextView
    var deleteButton: ImageButton = v.findViewById(R.id.button_delete) as ImageButton
